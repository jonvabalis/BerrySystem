...
namespace BerrySystem.Infrastructure.Migrations
{
    ...
    [Migration("20250730192058_Added_Roles_For_Employees")]
    partial class Added_Roles_For_Employees
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BerrySystem.Domain.Entities.Role", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("EmployeeRole", b =>
                {
                    b.HasOne("BerrySystem.Domain.Entities.Employee", null)
                        .WithMany()
                        .HasForeignKey("EmployeesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("BerrySystem.Domain.Entities.Role", null)
                        .WithMany()
